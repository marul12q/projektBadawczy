...
class GlandConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + gland
...
class GlandDataset(utils.Dataset):
    ...
    def load_gland(self, dataset_dir, subset):
        """Load a subset of the Gland dataset.
...
def train(model):
    ...
    dataset_train.load_gland(args.dataset, "train")
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        class InferenceConfig(GlandConfig):
